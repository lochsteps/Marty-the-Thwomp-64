...
local VOICETABLE_MARTY = {
    [CHAR_SOUND_ATTACKED] = 'Thwomp-Urgh.ogg',
    [CHAR_SOUND_DOH] = 'Thwomp-Urgh.ogg',
    [CHAR_SOUND_DROWNING] = 'Thwomp-Urgh.ogg',
    [CHAR_SOUND_DYING] = 'Thwomp-Urgh.ogg',
    [CHAR_SOUND_GROUND_POUND_WAH] = 'Thwomp-Urgh.ogg',
    [CHAR_SOUND_HAHA] = 'Thwomp-Urgh.ogg',
    [CHAR_SOUND_HAHA_2] = 'Thwomp-Urgh.ogg',
    [CHAR_SOUND_HERE_WE_GO] = 'Thwomp-Laugh.ogg',
    [CHAR_SOUND_HOOHOO] = 'Thwomp-Urgh.ogg',
    [CHAR_SOUND_MAMA_MIA] = 'Thwomp-Urgh.ogg',
    [CHAR_SOUND_OKEY_DOKEY] = 'Thwomp-Urgh.ogg',
    [CHAR_SOUND_ON_FIRE] = 'Thwomp-Laugh.ogg',
    [CHAR_SOUND_OOOF] = 'Thwomp-Urgh.ogg',
    [CHAR_SOUND_OOOF2] = 'NES-Hit.ogg',
    [CHAR_SOUND_PUNCH_HOO] = 'Thwomp-Urgh.ogg',
    [CHAR_SOUND_PUNCH_WAH] = 'Thwomp-Urgh.ogg',
    [CHAR_SOUND_PUNCH_YAH] = 'Thwomp-Urgh.ogg',
    [CHAR_SOUND_SO_LONGA_BOWSER] = 'Thwomp-Laugh.ogg',
    [CHAR_SOUND_TWIRL_BOUNCE] = 'Thwomp-Laugh.ogg',
    [CHAR_SOUND_WAAAOOOW] = 'Thwomp-Urgh.ogg',
    [CHAR_SOUND_WAH2] = 'Thwomp-Urgh.ogg',
    [CHAR_SOUND_WHOA] = 'Thwomp-Urgh.ogg',
    [CHAR_SOUND_YAHOO] = 'Thwomp-Urgh.ogg',
    [CHAR_SOUND_YAHOO_WAHA_YIPPEE] = 'Thwomp-Urgh.ogg',
    [CHAR_SOUND_YAH_WAH_HOO] = 'Thwomp-Urgh.ogg',
    [CHAR_SOUND_YAWNING] = 'Thwomp-Urgh.ogg',
}
